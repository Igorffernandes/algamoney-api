...
public class PessoaResource {
		...
		@GetMapping
		@PreAuthorize("hasAuthority('ROLE_PESQUISAR_PESSOA') and #oath2.hasScope('read')")
		public List<Pessoa> listar(){
				return pessoaRepository.findAll();
		}
		
		@PostMapping
		@PreAuthorize("hasAuthority('ROLE_CADASTRAR_PESSOA') and #oath2.hasScope('write')")
		...
		@GetMapping("/{codigo}")
		public ResponseEntity<Pessoa> findById(@PathVariable Long codigo) {
				Pessoa pessoa = categoriaRepository.findById(codigo).orElse(null);		
	    ...
	    */
		...
		@PreAuthorize("hasAuthority('ROLE_REMOVER_PESSOA') and #oath2.hasScope('write')")
