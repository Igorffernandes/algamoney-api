...
import com.algamoney.algamoneyapi.model.Categoria_;
import com.algamoney.algamoneyapi.model.Lancamento;
import com.algamoney.algamoneyapi.model.Lancamento_;
import com.algamoney.algamoneyapi.model.Pessoa_;
...
public class LancamentoRepositoryImpl implements LancamentoRepositoryQuery {
		...
		private Predicate[] criarRestricoes(LancamentoFilter lancamentoFilter, CriteriaBuilder builder,
				...
				//where descricao like '%sdawerwer%'
				
				//if(lancamentoFilter.getDescricao()!=null) {  //mesma coisa
